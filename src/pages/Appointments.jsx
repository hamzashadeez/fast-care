    ...
    <div>
      ...
      <div className="p-4 md:p-10 grid grid-cols-1 md:grid-cols-2 gap-3">
        {bookings.map((booking) => (
          <div className="flex flex-row gap-4 bg-white shadow-md p-4">
            ...
            <section>
              ...
              {booking?.status === "pending" && <div className="flex flex-row gap-3 mt-3">
                 <button onClick={()=>Approve(booking?.docId)} className="bg-brand text-white px-4 py-2 rounded-md">
                    Approve
                 </button>
              ...
              {booking?.status === "approved" && <div className="mt-3 bg-brand/20 text-brand py-2 rounded-md font-semibold text-sm text-center">Approved</div>}
              {booking?.status === "declined" && <div className="mt-3 bg-red-500/20 text-red-500 py-2 rounded-md font-semibold text-sm text-center">Declined</div>}
            </section>
